...
/// services.AddTransient<RefitCustomLoggingDelegatingHandler>();
/// </summary>
public class RefitCustomLoggingDelegatingHandler : DelegatingHandler
{
    public RefitCustomLoggingDelegatingHandler(HttpMessageHandler innerHandler = null)
